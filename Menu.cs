    ...
    public class OptionsMenu : OptionInterface
    {
        ...
        public override void Initialize()
        {
            ...
            UIelement[] element = new UIelement[]
            {
                ...
                new OpLabel(CHECKBOX_LABEL_HORIZONTAL, vert_pos, "Rivulet Drowning Immunity", false),
            ...
            UIelement[] element2 = new UIelement[]
            {
                ...
                new OpLabel(CHECKBOX_LABEL_HORIZONTAL, vert_pos, "Keep Items on Pickup", false),
                ...
                new OpLabel(SUB_CHECKBOX_LABEL_HORIZONTAL, vert_pos, "Allow Grabbing Food", false),
                ...
                new OpLabel(SUB_SUB_CHECKBOX_LABEL_HORIZONTAL, vert_pos, "Allow Grabbing Noodleflies", false),
                ...
                new OpLabel(SUB_SUB_CHECKBOX_LABEL_HORIZONTAL, vert_pos, "Allow Grabbing Centipedes", false),
                ...
                new OpLabel(SUB_SUB_CHECKBOX_LABEL_HORIZONTAL, vert_pos, "Allow Grabbing Five Pebble's Neurons", false),
                ...
                new OpLabel(SUB_SUB_CHECKBOX_LABEL_HORIZONTAL, vert_pos, "Allow Grabbing Mushrooms", false),
                new OpCheckBox(allowGrabbingKarmaFlowers, SUB_SUB_CHECKBOX_HORIZONTAL, vert_pos -= SUB_SUB_CHECKBOX_VERT_OFFSET),
                new OpLabel(SUB_SUB_CHECKBOX_LABEL_HORIZONTAL, vert_pos, "Allow Grabbing Karma Flowers", false),
                // Back to other options
                new OpCheckBox(canDropForFood, SUB_CHECKBOX_HORIZONTAL, vert_pos -= CHECKBOX_VERT_OFFSET),
                new OpLabel(SUB_CHECKBOX_LABEL_HORIZONTAL, vert_pos, "Allow Dropping Items", false),
            ...
            UIelement[] element3 = new UIelement[]
            {
                ...
                new OpLabel(CHECKBOX_LABEL_HORIZONTAL+IMAGE_TEXT_OFFSET, vert_pos, "Leech Protection", false),
                ...
                new OpLabel(CHECKBOX_LABEL_HORIZONTAL+IMAGE_TEXT_OFFSET, vert_pos, "Coalescipede Protection", false),
            ...
            UIelement[] element4 = new UIelement[]
            {
                ...
                new OpLabel(CHECKBOX_LABEL_HORIZONTAL, vert_pos, "Item Passing", false),
                ...
                new OpLabel(CHECKBOX_LABEL_HORIZONTAL, vert_pos, "Move Player Items", false),
                new OpLabel(CHECKBOX_LABEL_HORIZONTAL, vert_pos + DESC_OFFSET, "(When disabled piggybacked players will be skipped)", false),
                new OpLabel(CHECKBOX_HORIZONTAL, vert_pos-= MINI_CHECKBOX_VERT_OFFSET, "Keyboard", true),
